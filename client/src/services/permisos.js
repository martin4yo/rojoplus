...
export const PERMISOS = {
  ...
  // Tienda Online
  TIENDA_VER: 'TIENDA_VER',
  TIENDA_GESTIONAR: 'TIENDA_GESTIONAR',
  TIENDA_CONFIGURAR: 'TIENDA_CONFIGURAR',
}
