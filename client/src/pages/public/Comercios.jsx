...
import { MapPin, Phone, Navigation, Store, Percent, ArrowLeft, Filter } from 'lucide-react'
...
export default function ComerciosPublicos() {
  ...
  // Comercios con ubicación para el mapa
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center gap-3">
            <Link to="/mi-qr" className="text-gray-500 hover:text-primary">
            ...
            <div>
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-xs text-gray-400 italic whitespace-nowrap hidden sm:inline">
                  Tu pasion tiene recompensas
                </span>
              </div>
              <span className="text-gray-600 text-sm block">Comercios Adheridos</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <footer className="max-w-4xl mx-auto px-4 py-6 text-center">
        <p className="text-gray-400 text-sm">Club Sportivo Pilar - El Rojo de la Avenida</p>
      </footer>
    </div>
  )
}
